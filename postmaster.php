<?php
$EMAIL = 'Info@holding.bz'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'Info@holding.bz';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'Info@holding.bz';   //  e-mail для ответа 
